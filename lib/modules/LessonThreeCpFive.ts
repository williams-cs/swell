...
export class LessonThreeCpFive extends Module {
    ...
    readonly _instructions: string =
        `<p>Lesson 3 - Checkpoint 5</p>` +
        `<p>GOAL: Change the value of c around to see what is printed on the canvas.</p>`;

    readonly _starterCode: string =
        `c = 75
print(emoji("heart-eyes", c, c), x=60, y=60)
if(c < 100) {
  print("The emoji is smaller than the box.", x=220, y=220)
} else {
  print("The emoji is bigger than the box.", x=220, y=220)
}`;
