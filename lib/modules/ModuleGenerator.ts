...
export class ModuleGenerator {
  // static async createLesson(ctx: CanvasRenderingContext2D, editor: CodeMirror.Editor, url: string): Promise<LessonMaker>{
  //   let lesson = await LessonMaker.generateFromJSON(ctx, editor, url)
  //   return lesson
  // };
