...
describe('A MulOp', () => {
    it('should evaluate to a number', () => {
        ...
        const output = op.eval(new Scope_1.Scope(new Map(), null));
    ...
    it('should evaluate to a negative number', () => {
        ...
        const output1 = op1.eval(new Scope_1.Scope(new Map(), null));
    ...
    it('should evaluate to zero', () => {
        ...
        const output2 = op2.eval(new Scope_1.Scope(new Map(), null));
