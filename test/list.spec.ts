...
describe('A list', () => {
    ...
    it('when compared against another, different list should evaluate to false',() => {
        const list1 = new ListNode([[new NumberNode(0,null), ""],[new NumberNode(1,null),""], [new NumberNode(2,null),""],[new NumberNode(3,null),""]]);
        const list2 = new ListNode([[new NumberNode(0,null), ""],[new NumberNode(1,null),""], [new NumberNode(2,null),""],[new NumberNode(4,null),""]]);
        ...
        expect(output.val).to.deep.equal((new BooleanNode(false,comp1)).val);
    });
